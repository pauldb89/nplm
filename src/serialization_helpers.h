...
template<class Archive, class Key, class Value, class Hash>
inline void save(
    Archive& ar, const std::unordered_map<Key, Value, Hash>& map,
    const unsigned int version) {
...
template<class Archive, class Key, class Value, class Hash>
inline void load(
    Archive& ar, std::unordered_map<Key, Value, Hash>& map,
    const unsigned int version) {
  size_t num_entries;
  ar >> num_entries;
